...
\begin{figure}
    ...
    \includegraphics[width=\textwidth]{figures/links.pdf}
    \caption{Link variables, depicted as linking two adjacent lattice sites. Figure taken from Ref.~\cite{Gattringer:2010zz}.}
    \label{fig:links}
\end{figure}
...
\begin{figure}
    ...
    \caption{Depiction of the clover term, built out of four plauqettes. Figure taken from~\cite{Gattringer:2010zz}.}
    \label{fig:clover}
\end{figure}
