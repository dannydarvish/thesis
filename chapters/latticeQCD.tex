...
\begin{figure}
    ...
    \caption{Link variables, depicted as linking two adjacent lattice sites. Figure from Ref.~\cite{Gattringer:2010zz}.}
    \label{fig:links}
\end{figure}
...
\subsection{Improving the Discretized Action}
...
\begin{figure}
    ...
    \caption{Depiction of the clover term, built out of four plauqettes. Figure from~\cite{Gattringer:2010zz}.}
    \label{fig:clover}
\end{figure}
